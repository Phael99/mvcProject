...
public class EditPatientView extends javax.swing.JFrame {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        String gender = radioGroupGender.getSelection().getActionCommand();
        
        pc.edit(txtName.getText(), txtCpf.getText(), gender, age, id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditPatientView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditPatientView().setVisible(true);
            }
        });
    }
